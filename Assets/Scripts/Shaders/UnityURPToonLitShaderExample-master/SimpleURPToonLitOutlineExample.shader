...
*/ 
Shader "Custom/URP/SimpleURPToonLitExample(With Outline)"
{
    Properties
    {
        ...
        [Header(High Light)]
        [Toggle]_UseSpecularLight("Enable?", Float) = 0
        _SpecularLightAmount("SpecularLight", Range(0,0.5)) = 0.5
        ...
        [Header(SoftClip)]
        _FadeMinDistance ("Minimum Distance", float) = 2
        _FadeMaxDistance ("Maximum Distance", float) = 3
    }
    SubShader
    {       
        Tags 
